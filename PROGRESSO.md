...
- **➡️ PRÓXIMA:** Bloco 4 origens (impr. 46-53), Bloco 5 poderes de classe (54-77), Bloco 6 poderes gerais (78-95), Bloco 7 tabelas (96-101) — todos TEXTO (sem arte por entidade). Depois: **lote de arte das 13 variantes**. Procedimento P (pdftotext + imagem).
