...
**Totais Heróis até aqui:** 5 raças · 1 classe (Treinador) · **14 variantes** · 30 origens · **428 poderes** · ~9 regras (oficios-variados, poderes-de-brado, poderes-de-paixao, 6 tabelas). Build **2140 páginas**, tsc 0, **157 testes**.
  ...
  - **➡️ PRÓXIMA / dívidas:**
    1. **Arte das variantes** (parcial): ao listar `pdfimages` das páginas de abertura (PDF 26-47), a maioria só tem o balão decorativo (smask obj 3107); só algumas variantes têm figura de personagem isolada (ex.: Burguês PDF28 obj465, Machado de Pedra PDF34 obj499, Ventanista PDF46 obj547). → extrair arte só das que tiverem figura clara (cor+smask → `site/public/classes/<slug>.png`); as demais ficam sem (são "a mesma classe"). Conferir 2ª página de cada variante também. **Dívida, não-bloqueante.**
