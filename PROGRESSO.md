...
**Totais Heróis até aqui:** 5 raças · 1 classe (Treinador) · **14 variantes** · 30 origens · **428 poderes** · ~9 regras (oficios-variados, poderes-de-brado, poderes-de-paixao, 6 tabelas). Build **2140 páginas**, tsc 0, **157 testes**.
  ...
  - **Arte das variantes ✅ (decisão do usuário: só as que têm figura própria):** varredura de smasks em PDF 26-47 — só 2 variantes têm figura de personagem isolada: **Machado de Pedra** (v34-004) e **Ventanista** (v46-004), extraídas (cor+smask) → `site/public/classes/`. As demais 11 variantes NÃO têm arte de personagem própria no PDF (golem da p.28 é decorativo do Duelista; borda da p.29; demais só têm o balão obj 3107) → ficam sem imagem, fiel à fonte (são "a mesma classe").
