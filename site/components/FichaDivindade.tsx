    ...
    <article style={{ maxWidth: 760, margin: "0 auto", border: "2px solid var(--borda)", borderRadius: 16, overflow: "hidden", boxShadow: "0 18px 55px rgba(0,0,0,.6)" }}>
      ...
      <div style={{ background: "linear-gradient(180deg, var(--pergaminho-1), var(--pergaminho-2))", color: "var(--tinta)" }}>
        ...
        <div style={{ display: "flex", flexWrap: "wrap", gap: 14, padding: "18px 22px 8px" }}>
          {imagem && (
            <div style={{ flex: "1 1 200px", minWidth: 180, display: "flex", justifyContent: "center", alignItems: "flex-start" }}>
        ...
        <div style={{ padding: "0 24px 22px" }}>
          ...
          <section style={{ marginBottom: 14, display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(220px, 1fr))", gap: 10 }}>
